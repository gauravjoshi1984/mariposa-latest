...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-bookvitals-tabs-tabs-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesBookvitalsTabsTabsPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesBookvitalsTabsTabsRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var routes = [{
      ...
      children: [{
        ...
        loadChildren: function loadChildren() {
          ...
          /*! ../book/book.module */
          "./src/app/pages/bookvitals/book/book.module.ts")).then(function (x) {
            return x.BookPageModule;
          });
        }
      }, {
        path: "vitals",
        loadChildren: function loadChildren() {
          return __webpack_require__.e(
          /*! import() | vitals-vitals-module */
          "vitals-vitals-module").then(__webpack_require__.bind(null,
          /*! ../vitals/vitals.module */
          "./src/app/pages/bookvitals/vitals/vitals.module.ts")).then(function (x) {
            return x.VitalsPageModule;
          });
        }
      }, {
        path: "calendar",
        loadChildren: function loadChildren() {
          ...
          "./src/app/pages/bookvitals/calendar/calendar.module.ts")).then(function (x) {
            return x.CalendarPageModule;
          });
        }
      }, {
        path: "menu",
        loadChildren: function loadChildren() {
          return __webpack_require__.e(
          /*! import() | src-app-pages-hamburgermenu-menu-menu-module */
          "pages-hamburgermenu-menu-menu-module").then(__webpack_require__.bind(null,
          /*! src/app/pages/hamburgermenu/menu/menu.module */
          "./src/app/pages/hamburgermenu/menu/menu.module.ts")).then(function (x) {
            return x.MenuPageModule;
          });
        }
      }, {
        path: "",
  ...
  /***/
  function srcAppPagesBookvitalsTabsTabsModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesBookvitalsTabsTabsPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesBookvitalsTabsTabsPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var TabsPage = /*#__PURE__*/function () {
      ...
      _createClass(TabsPage, [{
        ...
        value: function changeTab(i) {
          this.TabsData.forEach(function (element) {
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])("iontabs")], TabsPage.prototype, "iontab", void 0);
    TabsPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/bookvitals/tabs/tabs.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./tabs.page.scss */
      "./src/app/pages/bookvitals/tabs/tabs.page.scss"))["default"]]
    })], TabsPage);
    /***/
  }
}]);
//# sourceMappingURL=pages-bookvitals-tabs-tabs-module-es5.js.map